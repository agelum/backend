...
// Validate ../../src/app/api/events/ack/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/events/ack">> = Specific
  const handler = {} as typeof import("../../src/app/api/events/ack/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
